...
public class IdiomPeiceScript : MonoBehaviour
{
    ...
    private void ObjectSnapped(SelectEnterEventArgs selectEnterEventArgs)
    {
        ...
        {
            // Notify the IdoiomPuzzleManager that a puzzle task is completed
            linkedPuzzleManager.CompletedIdiomPuzzleTask();
        }
    }
    ...
    private void ObjectRemoved(SelectExitEventArgs selectExitEventArgs)
    {
        ...
        {
            // Notify the IdoiomPuzzleManager that a puzzle task has been reversed
