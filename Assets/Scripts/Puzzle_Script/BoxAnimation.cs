...
{
    // Reference to the Animator component that controls the box's animations
    ...
    // Method to open the box and trigger the animation
    public void GetPrize()
    {
        // Set the "IsOpen" parameter in the Animator to true, triggering the box opening animation
